import pandas as pd
import numpy as np
from sklearn.ensemble import RandomForestClassifier  # Swapped from CatBoost/XGBoost
...
model = RandomForestClassifier(
    ...
    min_samples_leaf=4,    # Prevent overfitting on individual accounts
    random_state=42,
...
print("\n" + "="*60)
print("       RANDOM FOREST MODEL — ACCURACY REPORT")
print("="*60)
...
def rank_and_display(filtered, brand_name, top_n):
    ...
    # Random Forest returns 1D array of integers, ready for inverse_transform
